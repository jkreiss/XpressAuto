  ...
  return (
    <section id="contact" className={`py-20 ${sectionBackgroundClass} relative overflow-hidden`}>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className={`grid ${compact ? "lg:grid-cols-2" : "lg:grid-cols-2"} gap-10 md:gap-14 lg:gap-24`}>
          <div>
            ...
            <div className={`grid ${compact ? "sm:grid-cols-1" : "sm:grid-cols-2"} gap-6 md:gap-8`}>
              ...
              >
                ...
                <div>
                  ...
                  <span className="block text-base sm:text-lg font-medium break-all md:break-normal md:whitespace-nowrap transition-colors group-hover:text-primary">
          ...
          <div className="bg-card p-8 md:p-12 rounded-3xl border border-border shadow-2xl relative overflow-hidden">
