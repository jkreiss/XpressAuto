import { Activity, Wrench, ShieldCheck, AlertTriangle, CarFront } from "lucide-react";
...
export function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Mechanical repairs on all makes and models, including brakes, suspension, steering, and transmission systems.",
    ...
    <section id="services" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-muted-foreground text-lg font-medium leading-relaxed">We offer a comprehensive range of automotive services designed to keep your vehicle running at its best, safely and reliably.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="bg-card border border-black/5 rounded-2xl p-8 hover:-translate-y-2 hover:border-primary transition-all duration-500 shadow-xl hover:shadow-[0_0_30px_-5px_rgba(138,196,255,0.15)] group relative overflow-hidden"
