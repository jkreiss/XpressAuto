  ...
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 bg-background">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-foreground mb-6 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-150 max-w-5xl leading-[0.9] uppercase italic">
          Fast. Reliable. <span className="text-primary block md:inline not-italic">
            Trusted.
          </span>
        </h1>
        <p className="text-lg md:text-xl font-bold text-foreground/60 mb-12 max-w-xl animate-in fade-in duration-700 delay-300 leading-tight uppercase tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-7 duration-700 delay-500">
          <button 
            ...
            className="group relative inline-flex items-center justify-center gap-3 bg-primary text-primary-foreground px-10 py-5 text-xl font-black uppercase tracking-widest shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all w-full sm:w-auto"
          ...
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 border-2 border-foreground/10 bg-transparent px-10 py-5 text-xl font-black uppercase tracking-widest text-foreground hover:bg-foreground/5 hover:border-foreground/20 transition-all w-full sm:w-auto"
